...
;(function(){
 ...
 function init(){
  ...
  var _=this;
  if(circleNumber>0){
    var r=parseFloat(getStyle(circle,'width')+300)/2-2; 
    ...
    container.style.height=parseFloat(getStyle(circle,'width'))+200+'px';
     mainContent.style.width=parseFloat(getStyle(circle,'width')+100)+'px';
     mainContent.style.height=parseFloat(getStyle(circle,'width')+100)+'px';



    mainContent.style.width = 450+'px';
    mainContent.style.height = 450+'px';
    ...
    for(var i=0;i<circleNumber;i++){
	    ...
	    var si=s*i;
	    var x=(r+3*minCirclesR)*Math.cos(si);
	    var y=(r+3*minCirclesR)*Math.sin(si);
